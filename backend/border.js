...
const rectSize = 13; // Size of each small rectangle
const totalWidth = 750; // Outer rectangle width
const totalHeight = 750; // Outer rectangle height
